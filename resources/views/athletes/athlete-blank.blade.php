    ...
    <div class="card-body" style="display: none;">
        <form method="POST" action="/athlete" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <input id="secondname" type="text" class="form-control @error('secondname') is-invalid @enderror" name="secondname" value="">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <input id="firstname" type="text" class="form-control @error('firstname') is-invalid @enderror" name="firstname" value="">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <input id="patronymic" type="text" class="form-control @error('patronymic') is-invalid @enderror" name="patronymic" value="">
