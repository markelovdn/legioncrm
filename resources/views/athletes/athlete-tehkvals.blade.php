        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-auto">
                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-tehkval-destroy{{$tehkval->id}}">
                            <i class="far fa-trash-alt"></i>
                        </button>
                    </div>

                    {{--modal-destroy-tehkval--}}
                    <div class="modal fade" id="modal-tehkval-destroy{{$tehkval->id}}" style="display: none;" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-body">
